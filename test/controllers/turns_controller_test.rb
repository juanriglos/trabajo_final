...
class TurnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turn" do
    assert_difference('Turn.count') do
      post turns_url, params: { turn: { end_time: @turn.end_time, start_date: @turn.start_date } }
    end
  ...
  test "should update turn" do
    patch turn_url(@turn), params: { turn: { end_time: @turn.end_time, start_date: @turn.start_date } }
